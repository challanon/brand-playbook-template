...
# Northstar context packs

Always load `BRANDBOOK.md` first.

| Task | Additional files | Output |
| --- | --- | --- |
| Activation-measurement guide | Anchor rules, compliance, voice, messaging, audience, SEO/GEO | Answer-first guide with cited metric definitions |
