...
Packages opting in set `profile: production` in `BRANDBOOK.md` and must pass the strict validator. Consumers should also require valid records defined in [`../contracts/`](../contracts/) for agent execution and CMS handoff.
